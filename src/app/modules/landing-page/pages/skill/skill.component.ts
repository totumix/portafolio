...
export class SkillComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.skills = [
      ...
      { label: "Angular 2+", points: [true, true, true, true, false] },
      { label: "Nodejs", points: [true, true, true, true, false] },
      ...
      { label: "Flexbox", points: [true, true, true, true, false] },
      ...
      { label: "Mongo DB", points: [true, true, true, true, false] },
